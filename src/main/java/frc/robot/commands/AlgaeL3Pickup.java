...
public class AlgaeL3Pickup extends Command {
    ...
    public AlgaeL3Pickup(SubsystemManager manager, EndEffector endEffector, Pivot s_Pivot, 
    ...
    public void initialize() {
        manager.requestNode("L3 Algae Pickup");
