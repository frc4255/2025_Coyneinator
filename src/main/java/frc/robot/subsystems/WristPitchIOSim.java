...
public class WristPitchIOSim implements WristPitchIO {
    private static final double MAX_VELOCITY = 6.0; // rad/s
    private static final double MAX_ACCELERATION = 35.0; // rad/s^2
    private static final double DAMPING_COEFFICIENT = 2.5;
    ...
    public void updateInputs(WristPitchIOInputs inputs) {
        ...
        inputs.currentAmps = Math.abs(appliedVolts) / 12.0 * 30.0;
    }
