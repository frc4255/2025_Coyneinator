...
public class AutoAlignController extends SubsystemBase {
    ...
    public void periodic() {
        ...
        Logger.recordOutput("AutoAlign/RobotState", state.name());
        Logger.recordOutput("AutoAlign/HasPose", lastRequestedPose.isPresent());
        lastRequestedPose.ifPresent(pose -> Logger.recordOutput("AutoAlign/LastPose", pose));
        Logger.recordOutput("AutoAlign/HasLevel", lastRequestedLevel.isPresent());
        lastRequestedLevel.ifPresent(level -> Logger.recordOutput("AutoAlign/LastLevel", level));
    }
