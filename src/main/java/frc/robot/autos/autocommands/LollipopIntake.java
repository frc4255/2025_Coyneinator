...
public class LollipopIntake extends Command {
    ...
    public LollipopIntake(SubsystemManager manager, Pivot s_Pivot,
    ...
    public void initialize() {
         ...
         */
        manager.requestNode(GraphParser.getNodeByName("Lollipop Coral Intake"));
