        ...
        addCommands(
            ...
            new ParallelCommandGroup(
                ...
                new SequentialCommandGroup(
                    new Score(scoringLevels[0], manager, s_Pivot, s_Elevator, s_WristPitch, s_WristRoll, s_Swerve, s_EndEffector, () -> true).withTimeout(3),
            ...
            new SequentialCommandGroup(
                new Score(scoringLevels[0], manager, s_Pivot, s_Elevator, s_WristPitch, s_WristRoll, s_Swerve, s_EndEffector, () -> true).withTimeout(2),
                new ExtakeCoral(s_EndEffector).withTimeout(0.5),
                new Stow(manager, s_Pivot, s_Elevator, s_WristPitch, s_WristRoll)
            ),  
