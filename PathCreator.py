...
graph = {
    ...
    "Reef Align": ["Stow", "L4 Init", "L3 Init", "Lollipop Coral Pickup", "L4 Dunk", "L3 Dunk", "L3 Algae Pickup", "L2 Algae Pickup", "Coral Ground Pickup"],
    "L4 Init": ["L3 Init", "Reef Align"],
    "L3 Init": ["L4 Init", "Reef Align"],
    "L3 Dunk": ["Reef Align"],
